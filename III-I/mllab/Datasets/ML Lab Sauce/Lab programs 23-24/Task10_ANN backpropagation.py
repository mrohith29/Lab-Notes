...
#Forward Propogation
 ...
 wout += hlayer_act.T.dot(d_output) *lr # dotproduct of nextlayererror and currentlayerop # bout += np.sum(d_output, axis=0,keepdims=True)Python program to implement Boosting ensemble method*lr
